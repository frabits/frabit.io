    ...
    return (
        <div className={classNames(display=="1"?"":"hidden","bg-cyan-500 rounded-2xl pr-20 pl-20 relative z-20 text-white transition-colors duration-200")}>
            <div className="grid grid-cols-3 justify-items-center">
                ...
                <a className="group/link relative -z-10 mx-auto flex h-14 w-full items-center justify-center px-4.5 md:h-[46px]"
                   href={bannerUrl}
                >
                    <p className="flex flex-row justify-items-center items-center justify-center mb-4 mt-4 font-bold text-cyan-50">{bannerText}
                ...
                <div className={classNames(disable?"":"invisible","flex absolute inset-y-0 right-3 w-8 hover:border-cyan-600 rounded-xl p-2")}>

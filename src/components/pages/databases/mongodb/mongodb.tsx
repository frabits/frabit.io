...
import Highlights from "@/components/pages/databases/mongodb/highlights";
import Features from "@/components/pages/databases/mongodb/features";
import Faq from "@/components/pages/databases/mongodb/faq";
        ...
        <div className="w-full p-8 ">
            <div className="container gap-sm-grid items-center group pt-20 grid grid-cols-2">
                <div className="col-start-1 items-center p-10">
                    <div className="">
                        <h1 className="text-cyan-50 text-4xl font-bold font-large">MongoDB</h1>
                        <p className="text-cyan-50 text-20 pt-5">Version 6.2,7.2</p>
                    </div>
                    <div className="py-10">
                        <p className="text-cyan-50 text-20 pt-5">Ensure high availability for all your MongoDB instances by automating deployments, both on-premise and in the cloud, following the vendors’ recommended best practices from the start.</p>

...
import Highlights from "@/components/pages/databases/redis/highlights";
import Features from "@/components/pages/databases/redis/features";
import Faq from "@/components/pages/databases/redis/faq";
        ...
        <div className="w-full p-8 ">
            <div className="container gap-sm-grid items-center group pt-20 grid grid-cols-2">
                <div className="col-start-1 items-center p-10">
                    <div className="">
                        <h1 className="text-cyan-50 text-4xl font-bold font-large">Redis</h1>
                        <p className="text-cyan-50 text-20 pt-5">Version 6.2,7.2</p>
                    </div>
                    <div className="py-10">
                        <p className="text-cyan-50 text-20 pt-5">Ensure high availability for all your Redis instances by automating deployments, both on-premise and in the cloud, following the vendors’ recommended best practices from the start.</p>

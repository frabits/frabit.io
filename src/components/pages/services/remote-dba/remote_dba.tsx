...
import Highlights from "@/components/pages/databases/clickhouse/highlights";
import Features from "@/components/pages/databases/clickhouse/features";
import Faq from "@/components/pages/databases/clickhouse/faq";
        ...
        <div className="w-full p-8 ">
            <div className="container gap-sm-grid items-center group pt-20 grid grid-cols-2">
                <div className="col-start-1 items-center p-10">
                    <div className="">
                        <h1 className="text-cyan-50 text-4xl font-bold font-large">ClickHouse</h1>

    ...
    return (
        <>
            ...
            <p className="text-cyan-50 sm:my-3">
                Last modified: <time>Aug 1, 2023</time>
            </p>
            ...
            <h2 className="text-cyan-50">Personal information we collect</h2>
            ...
            <p className="text-cyan-50">We collect Device Information using the following technologies:</p>
            ...
            <h2 className="text-cyan-50">How do we use your personal information</h2>
            <p className="text-cyan-50">
            ...
            <h2 className="text-cyan-50">Sharing your personal information</h2>
            <p className="text-cyan-50">
                ...
                <a href="https://support.google.com/analytics/answer/181881" target="_blank">
            ...
            <h2 className="text-cyan-50">Do not track</h2>
            <p className="text-cyan-50">
            ...
            <h2 className="text-cyan-50">Your rights</h2>
            <p className="text-cyan-50">
            ...
            <h2 className="text-cyan-50">Data retention</h2>
            <p className="text-cyan-50">
